...
const UpdateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
        const listingId = params.listingId; //params is used to get the dynamic part of the url (in this case listingId)
  ...
  const handleRemoveImage = (index) => {
    setFormData({
      ...formData,
      // Remove the image at the specified index from the imageUrls array. "_" represents current image URL (unused), "i" is the current index
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(+formData.regularPrice < +formData.discountPrice) return setError("Discounted price must be less than regular price"); // "+" converts string to number
      setLoading(true);
      setError(false);
